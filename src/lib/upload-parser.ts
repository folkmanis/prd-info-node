...
import {
  ArchiveJob,
  XmfUploadProgress,
} from '../interfaces/xmf-archive.interface';
...
export class UploadProgressTracker {
  ...
  constructor(private xmfDao: XmfSearchDao) {}
  ...
  async start(inf: Partial<XmfUploadProgress>): Promise<ObjectId | undefined> {
    ...
    this.progress._id =
      (await this.xmfDao.startUploadProgress(this.progress)) || undefined;
    return this.progress._id;
  }
  /**
