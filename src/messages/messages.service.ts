...
export class MessagesService {
    ...
    collection: Collection<MessageBase> = this.dbService.db().collection('messages');
    ...
    async getMessages(from: Date, to: Date, modules: SystemModules[], username: string): Promise<MessageBase[]> {
        const pipeline: any[] = [
            {
                $match: {
                    timestamp: {
